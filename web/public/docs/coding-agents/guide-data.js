...
export const guides = {
  ...
  claude: {
    ...
    commands: [
      ...
      ["/tldr <on|off|default>", "Toggle compact summaries."],
      ["/switch [account]", "List configured Claude accounts, or move every conversation onto one. Requires CLAUDE_ACCOUNTS."],
      ["/stop", "Cancel the current run."],
      ["/status", "Show binding and execution settings."],
      ["/commands", "Show the available Agora commands."],
    ],
    env: [
      ...
      ["CLAUDE_CONFIG_DIR", "Optional", "~/.claude", "Claude Code configuration, credentials and projects directory for single-account operation."],
      ["CLAUDE_ACCOUNTS", "Optional", "Empty (the single account in CLAUDE_CONFIG_DIR)", "Comma-separated name:path pairs for Claude accounts signed in on this computer, each path its own CLAUDE_CONFIG_DIR. Switch bridge-wide with /switch; account-local session ids are released."],
      ["ANTHROPIC_API_KEY", "Optional", "Empty", "Claude credential override. When set it takes precedence over directory-scoped OAuth, so multi-account switching is disabled."],
      ["ANTHROPIC_AUTH_TOKEN", "Optional", "Empty", "Claude credential override. When set it takes precedence over directory-scoped OAuth, so multi-account switching is disabled."],
      ["CLAUDE_CODE_OAUTH_TOKEN", "Optional", "Empty", "Claude OAuth-token override. When set it takes precedence over CLAUDE_CONFIG_DIR, so multi-account switching is disabled."],
